  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center py-8">
      <div className="bg-white p-8 rounded-lg shadow-xl max-w-4xl w-full">
        <h2 className="text-4xl font-semibold mb-8 text-center text-[#8B5DFF]">Our Mentorship Services</h2>
        
        {/* Service 1: Personal Growth */}
        <div className="mb-8">
          <h3 className="text-2xl font-bold mb-4  text-[#8B5DFF]    ">Personal Growth Mentorship</h3>
        ...
        <div className="mb-8">
          <h3 className="text-2xl font-bold mb-4   text-[#8B5DFF]   ">Career Development Mentorship</h3>
          <p className="text-lg text-gray-700">
        ...
        <div className="mb-8">
          <h3 className="text-2xl font-bold mb-4  text-[#8B5DFF]   ">Leadership and Influence Mentorship</h3>
          <p className="text-lg text-gray-700">
        ...
        <div className="mb-8">
          <h3 className="text-2xl font-bold mb-4  text-[#8B5DFF]    ">Mindfulness and Well-being Mentorship</h3>
          <p className="text-lg text-gray-700">
        ...
        <div className="mb-8">
          <h3 className="text-2xl font-bold mb-4 text-[#8B5DFF]   ">Life Transition Mentorship</h3>
          <p className="text-lg text-gray-700">
        ...
        <div className="mb-8">
          <h3 className="text-2xl font-bold mb-4 text-[#8B5DFF]   ">Confidence and Public Speaking Mentorship</h3>
          <p className="text-lg text-gray-700">
