    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center py-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl w-full px-6 mt-14">
        ...
        <div className="bg-white p-10 rounded-lg shadow-lg flex flex-col items-center">
          <h2 className="text-3xl font-bold mb-6 text-[#8B5DFF]">Who We Are</h2>
        ...
        {/* Card 2: Our Mission */}
        <div className="bg-white p-10 rounded-lg shadow-lg flex flex-col items-center">
          <h2 className="text-3xl font-bold mb-6 text-[#8B5DFF]">Our Mission</h2>
          <p className="text-lg text-gray-700 text-center">
        ...
        {/* Card 3: Our Vision */}
        <div className="bg-white p-10 rounded-lg shadow-lg flex flex-col items-center">
          <h2 className="text-3xl font-bold mb-6 text-[#8B5DFF]">Our Vision</h2>
          <p className="text-lg text-gray-700 text-center">
