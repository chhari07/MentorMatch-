  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="w-full max-w-md bg-white shadow-lg rounded-lg p-8">
        <h1 className="text-2xl font-semibold text-center text-[#8B5DFF] mb-6">
          Sign Up
        </h1>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full py-2 px-4 bg-[#8B5DFF] text-white font-semibold rounded-lg shadow-md hover:bg-[#7043D5] focus:outline-none focus:ring-2 focus:ring-[#8B5DFF] focus:ring-opacity-75 transition"
          >
            Sign Up
          </button>
        </form>
        ...
        <div className="mt-4 text-center">
          <Link
            ...
            className="text-[#8B5DFF] hover:underline transition duration-200"
          >
